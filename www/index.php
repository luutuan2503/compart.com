...
<div id="container">
    ...
    <div id="header-wrapper">
      ...
      <div id="header">
        ...
        <form action="action.php">
        	...
        	<input type="submit" name="auth" value="ok" />
        </form>
        </ul></li>
            <ul>
              <li><a href="index.php" class="selected">Домашняя</a></li>
              <li><a href="portfolio.php">Галерея</a></li>
              <li><a href="services.php">Статьи</a></li>
  ...
  <div id="wrapper">
    <!-- Begin Intro -->
    <div class="intro">
      <h1>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium. Praesent urna urna, venenatis at ultrices ac, viverra in turpis. Duis sceler isque mauri sut metus. </h1>
    </div>
    <!-- End Intro -->
    <!-- Begin About -->
    <div id="about">
      <div class="one-fourth"><a href="services.php"><img src="style/images/art/home-1.jpg" alt="" /></a>
        <h4>Phasellus Risus Quam</h4>
